...
INSERT INTO `Leagues` VALUES (1,'Spring','2020-03-01 00:00:00','2020-04-27 00:00:00',20,5,10,1,'Broomball','CoRec Intramural'),(2,'Spring','2020-03-01 00:00:00','2020-04-27 00:00:00',20,5,5,1,'Basketball','Men\'s Interhall'),(3,'Spring','2020-03-01 00:00:00','2020-04-27 00:00:00',NULL,5,20,1,'Volleyball','Women\'s Interhall');
...
CREATE TABLE `Team_Requests` (
  ...
  `new_member_invited` int(1) DEFAULT NULL,
  `new_member_accepted` int(1) DEFAULT NULL,
  PRIMARY KEY (`team_id`)
...
INSERT INTO `Teams` VALUES (1,1,0,'Shamrocks',1,1,0),(2,1,0,'Leprechauns',0,2,0),(3,1,0,'Broom Roasted',1,1,0),(4,1,0,'Sk8ters',0,2,0),(5,1,0,'Broom Ballers',2,0,0),(6,2,0,'Irish',2,1,0),(7,2,0,'Siegfried Boys',0,2,0),(8,2,0,'Ice Climbers',3,0,0),(9,2,0,'Almost Varsity',1,2,0),(10,2,0,'Homies',0,3,0),(11,3,0,'The Army',0,0,0),(12,3,0,'Fools of Ourselves',0,0,0),(13,3,0,'Good & Long Time',0,0,0),(14,3,0,'In it to Win it',0,0,0),(15,3,0,'STEM Ballers',0,0,0);
...
INSERT INTO `Users_Teams` VALUES (1,1),(2,1),(3,2),(4,2),(6,3),(7,3);
...
-- Dump completed on 2020-02-10 20:36:12
